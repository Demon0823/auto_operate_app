...
let inputFilePath = path.resolve(__dirname, "input", "内蒙古/batch_2.xlsx") // 输入的 Excel 文件路径
const outputFilePath = path.resolve(__dirname, "output", "内蒙古-已出席-No1-batch2.xlsx") // 输出的 Excel 文件路径
