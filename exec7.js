...
let inputFilePath = path.resolve(__dirname, "input", "batch_21.xlsx") // 输入的 Excel 文件路径
const outputFilePath = path.resolve(__dirname, "output", "江苏-已出席-No1-batch21.xlsx") // 输出的 Excel 文件路径
