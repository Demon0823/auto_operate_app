...
let inputFilePath = path.resolve(__dirname, "input", "吉林/batch_2.xlsx") // 输入的 Excel 文件路径
const outputFilePath = path.resolve(__dirname, "output", "吉林-已出席-No1-batch2.xlsx") // 输出的 Excel 文件路径
