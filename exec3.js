...
let inputFilePath = path.resolve(__dirname, "input", "宁夏/batch_1.xlsx") // 输入的 Excel 文件路径
const outputFilePath = path.resolve(__dirname, "output", "宁夏-已出席-No1-batch1.xlsx") // 输出的 Excel 文件路径
