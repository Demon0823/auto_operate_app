...
let inputFilePath = path.resolve(__dirname, "input", "山西/batch_3.xlsx") // 输入的 Excel 文件路径
const outputFilePath = path.resolve(__dirname, "output", "山西-未上课-No1-batch3.xlsx") // 输出的 Excel 文件路径
