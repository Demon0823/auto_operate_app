...
let inputFilePath = path.resolve(__dirname, "input", "湖北/batch_5.xlsx") // 输入的 Excel 文件路径
const outputFilePath = path.resolve(__dirname, "output", "湖北-已出席-No1-batch5.xlsx") // 输出的 Excel 文件路径
