...
let inputFilePath = path.resolve(__dirname, "input", "batch_17.xlsx") // 输入的 Excel 文件路径
const outputFilePath = path.resolve(__dirname, "output", "北京-已出席-No1-batch17.xlsx") // 输出的 Excel 文件路径
