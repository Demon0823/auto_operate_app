...
let inputFilePath = path.resolve(__dirname, "input", "湖北-未上课-No1/batch_12.xlsx") // 输入的 Excel 文件路径
const outputFilePath = path.resolve(__dirname, "output", "湖北-未上课-No1-batch12.xlsx") // 输出的 Excel 文件路径
